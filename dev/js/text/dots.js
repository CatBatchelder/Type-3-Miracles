...
export function dotsAnimation(){
    dotsTL.from("#moval1",{ duration: begTextDrawSpeed, alpha: 0, ease:"none", fill: "#ff0000",  motionPath: { path: "#mpath1", align: "#mpath1", start:1, end:0 }}, "mpath")
            .to("#moval1", {alpha:0}, "ipath")
            .from("#moval2",{ duration: begTextDrawSpeed, alpha: 0, ease:"none", fill: "#ff0000",  motionPath: { path: "#mpath2", align: "#mpath2", start:1, end:0 }}, "mpath")
            .to("#moval2", {alpha:0}, "ipath")
            .from("#moval3",{ duration: begTextDrawSpeed, alpha: 0, ease:"none", fill: "#ff0000",  motionPath: { path: "#mpath3", align: "#mpath3", start:1, end:0 }}, "mpath")
            .to("#moval3", {alpha:0}, "ipath")

            .from("#ioval1",{ duration: begTextDrawSpeed, alpha: 0, ease:"none", fill: "#ff0000",  motionPath: { path: "#ipath1", align: "#ipath1", start:1, end:0 }}, "mpath")
            ...
            .from("#roval1",{ duration: dotsDrawSpeed, alpha: 0, ease:"none", fill: "#ff0000",  motionPath: { path: "#outerrpath2", align: "#outerrpath2", start:1, end:0 }}, "ipath")
            .to("#roval1", {alpha:0}, "rpath")
